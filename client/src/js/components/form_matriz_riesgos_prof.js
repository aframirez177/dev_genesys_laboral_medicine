...
export function initializeForm() {
    ...
    function getGesListByRiesgo(riesgo) { /* ... (tu lista completa de GES) ... */
        const gesLists = {
            ...
            'Físico': ['Iluminación deficiente', 'Iluminación en exceso', 'Presiones anormales', 'Radiaciones ionizantes', 'Radiaciones no ionizantes', 'Ruido', 'Temperaturas extremas: calor', 'Temperaturas extremas: frío', 'Vibraciones mano-cuerpo', 'Vibraciones cuerpo completo', 'Cambios bruscos de temperatura', 'Humedad Relativa (Vapor de agua)'],
            ...
            'Biológico': ['Presencia de animales/vectores transmisores de enfermedad', 'Exposición a material contaminado o con riesgo biológico', 'Manipulación de alimentos'],
